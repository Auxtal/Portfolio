<script lang="ts">
  ...
  const submitToggleTheme: SubmitFunction = () => {
    const doc = document.documentElement;
...
<form
  method="POST"
  action="/?/toggleTheme&redirect={$page.url.pathname}"
...
>
  ...
  >
    <svg
      class="swap-on h-10 w-10 fill-current p-1 active:scale-[0.9] md:group-hover:scale-[0.9] md:group-focus-visible:scale-[0.9]"
    ...
    >
    <svg
      class="swap-off h-10 w-10 fill-current p-1 active:scale-[0.9] md:group-hover:scale-[0.9] md:group-focus-visible:scale-[0.9]"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      ><path

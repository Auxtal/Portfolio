      ...
      >
        <div class="form-item relative mb-5 mt-2">
          <input
            ...
            class="peer input outline my-2 block w-full !rounded-md bg-transparent px-4 text-sm text-secondary placeholder-secondary/50 shadow-md outline-2 outline-secondary/20 backdrop-blur-sm transition-all focus-visible:outline-[2.5px] focus-visible:outline-neutral"
        ...
        <div class="form-item relative mb-5 mt-2">
          <textarea
            ...
            class="peer textarea outline my-2 block w-full resize-none !rounded-md bg-transparent px-4 pt-3 text-sm text-secondary placeholder-secondary/50 shadow-md outline-2 outline-secondary/20 backdrop-blur-sm transition-all focus-visible:outline-[2.5px] focus-visible:outline-neutral"
